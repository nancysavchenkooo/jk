...
-----------------------------------------------------""")
    ...
    def ua_api(self):
        ...
        return (f"Dalvik/2.1.0 (Linux; U; Android 11; RMX3396 Build/RP1A.201005.001) [FBAN/EMA;FBBV/470353487;FBAV/353.0.0.5.112;FBDV/RMX3396;FBLC/id_ID;FBNG/WIFI;FBMNT/METERED;FBDM/"+"{density=3.0}]")
